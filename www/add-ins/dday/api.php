...
if ($currentTime >= mktime(0, 0, 0, 10, 8, 2016)) {
...
if ($currentTime >= strtotime("-1 week", mktime(0, 0, 0, 10, 8, 2016))) {
    // 1주일전
...
if ($currentTime >= mktime(13, 0, 0, 10, 8, 2016)) {
    // 당일 13시
    $welcomeText = "아직 늦지 않았습니다! 서둘러 주세요~";
}

if ($currentTime >= mktime(15, 0, 0, 10, 8, 2016)) {
    // 당일 15시
